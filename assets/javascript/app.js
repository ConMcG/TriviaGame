...
var questions = [
{
	...
	choices: ["Carl", "Charles", "Daryl", "Glenn", "Gary"],
	choicesAnswer: 4
},
{
	question: "In Season 2, episode 5 (Halloween), what is the name of the person who was fired??",
	choices: ["Tony", "Dave", "Devon", "Walter", "Creed"],
	choicesAnswer: 2
},
{
	question: "In the Fun Run episode, what objects in Angela's freezer convinced her that Dwight had killed her cat??",
	choices: ["Bags of vegetables", "Bags of french fries", "Frozen meat", "Tubs of Ice Cream", "Popsicles"],
	choicesAnswer: 1
},
{
	question: " In the episode Diwali, Michael eats some Indian food and spits it out because he thought it was what?",
	choices: ["S'mores", "Chicken Fingers", "Pizza", "Chicken", "Brownies"],
	choicesAnswer: 0
},
{
	question: "What is the exclusive club that Pam, Oscar, and Toby establish in the episode Branch Wars?",
	choices: ["High Society Club", "Literature Club", "Fancy Things Club", "Finer Things Club", "Tea Time Club"],
	choicesAnswer: 3
},
{
	question: "In The Fire, the fourth episode of the second season, what is Michael's ringtone?",
	choices: ["My Humps", "Spiderwebs", "Mambo No. 5", "Meet Virginia", "Hit Me Baby, One More Time"],
	choicesAnswer: 2
}];
